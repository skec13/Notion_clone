...
Why this project:
* to have a personalized notion-like life planner
* to integrate basic CRUD operations on database
...
1. Clone the repo
   ```sh
   git clone https://github.com/skec13/Notion_clone.git
   ```
...
4. Run server locally
   ...
   ```
5. Access web page
   [http://localhost:3000](http://localhost:3000) (check console for correct port)
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
[mongo]:https://img.shields.io/badge/mongo-ffffff?style=for-the-badge&logo=mongoDB&logoColor=green
